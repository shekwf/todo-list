<?php defined('BASE_PATH') OR die("Permision Denied!");//برای امنیت و جلوگیری از دسترسی مستقیم ب فایل
// alternative to top code
// if(!defined('BASE_PATH')){//فایل مستقیم باز شده باشه و تعریف نشده باشه
...
function getTasks(){
    global $pdo;
    $folder = $_GET['folder_id'] ?? null;//یا مقدار داره یا اگ نداشت نال میشه
    $folderCondition = '';
